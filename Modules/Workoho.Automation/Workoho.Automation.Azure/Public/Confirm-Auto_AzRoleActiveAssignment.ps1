...
.EXAMPLE
    PS> Confirm-Auto_AzRoleActiveAssignment -Roles @{
...
#>
function Confirm-Auto_AzRoleActiveAssignment {
    [CmdletBinding()]
    ...
    Connect-Auto_MgGraph # Connect to Microsoft Graph and implicitly to Azure cloud
    ...
    $currentUserGroups = @((Invoke-Auto_MgGraphRequest @{
