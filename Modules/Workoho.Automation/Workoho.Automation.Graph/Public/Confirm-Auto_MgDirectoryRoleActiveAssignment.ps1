...
.EXAMPLE
    PS> Confirm-Auto_MgDirectoryRoleActiveAssignment -Roles @( @{ TemplateId = '62e90394-69f5-4237-9190-012177145e10'; DisplayName = 'Global Administrator' }, 'Privileged Role Administrator' )
...
function Confirm-Auto_MgDirectoryRoleActiveAssignment {
    [CmdletBinding()]
    Param(
    ...
    $return = Get-Auto_MgDirectoryRoleActiveAssignment
